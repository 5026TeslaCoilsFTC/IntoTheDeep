...
public class setExtensionServo extends OpMode {
    ...
    public void init() {
        ...
        try {
            extensionServo1 = hardwareMap.get(Servo.class, "tiltServo");
    ...
    public void start() {
        ...
        if (extensionServo1 != null) {
            extensionServo1.setPosition(0.5);
        }
        if (extensionServo2 != null) {
            extensionServo2.setPosition(0.5);
        }
